package com.example.Bakery.Management.System.Component;
...
public class JwtTokenProvider {
    ...
    public String generateToken(User user) {
        ...
        return createToken(claims, user.getIdCard()); // Sử dụng idCard hoặc tên người dùng làm subject
    }
    ...
    public Boolean validateToken(String token, User user) {
        ...
        return (username.equals(user.getIdCard()) && !isTokenExpired(token) ); // Kiểm tra idCard
    }
}
